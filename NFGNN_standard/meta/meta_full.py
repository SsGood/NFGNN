...
def trial(hyperpm):
    ...
    cmd = 'python train_model_inductive.py --net NFGNN'
...
space = {'lr': hyperopt.hp.choice('lr', [0.01, 0.05, 0.001, 0.005, 0.002]),
         'prop_lr': hyperopt.hp.choice('prop_lr', [0.01, 0.05, 0.001, 0.005, 0.002]),
         'weight_decay': hyperopt.hp.choice('weight_decay', [0.0005, 0.00025, 0.0001, 0.001, 0.0025, 0.005, 0.0]),
         'prop_wd': hyperopt.hp.choice('prop_wd', [0.0005, 0.00025, 0.0001, 0.001, 0.0025, 0.005, 0.0]),
         'hidden': hyperopt.hp.choice('hidden', [32, 64, 128,256]),
